...
docker build -t registry.mouse.center:1443/gocd-agent-node16:$VERSION -f ./Dockerfile-gocd-agent-node16 .
docker push registry.mouse.center:1443/gocd-agent-node16:$VERSION
